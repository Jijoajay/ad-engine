...
export default function Home() {
  ...
  const queryStep = searchParams.get("type"); // get 'type' from query
  ...
  const handleProjectSelect = (project: any) => {
    if (project.hash_id) sessionStorage.setItem("selected_project_hash", project.hash_id);
